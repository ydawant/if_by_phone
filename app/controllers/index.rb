...
get '/phone_redirect' do
	...
	"It is currently #{current_temp} and #{summary} in #{params[:answer]} with a #{chance_of_rain} percent chance of rain. The max temperature for the day is #{max_temp} and the minimum temperature is #{min_temp}"
end
